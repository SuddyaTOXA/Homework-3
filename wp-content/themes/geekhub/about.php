    ...
    <div id="content">
        <div class="about">
            ...
            <ul>
                ...
                <li>
                    <p>Якщо ви зацікавлені у співробітництві з GeekHub, або у вас є ідеї щодо того, як зробити GeekHub краще - будь-ласка, <a href="http://homework.local/contacts/">зв'яжіться з нами</a> будь яким зручним для вас шляхом.</p>
                </li>
            </ul>
        </div>
    </div><!-- content -->
